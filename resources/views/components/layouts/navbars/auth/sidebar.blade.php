<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('admin.dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">URL Shortener</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin.redirection.manage' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Redirections</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin.user.profile' ? 'active' : '' }}"
