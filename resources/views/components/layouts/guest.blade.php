...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('guest/assets/img/favicon-2.ico') }}" />
...
<body class="index-page">
    ...
    <script data-navigate-once src="{{ asset('guest/assets/js/core/bootstrap.min.js') }}" type="text/javascript">
    </script>
